...
/** @addtogroup plugin-bulb-pwm-cli Plugin Commands for Bulb Pwm Driver
 * @ingroup cli
...
/** @brief <b>plugin bulb-pwm ledBlink [count:1] [time:2] </b>
 *   - <i>Exercise the blink led command.</i>
 *     - count - INT8U - count
 *     - time - INT16U - time
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_BULB_PWM_CLI_PLUGIN_BULB_PWM_LED_BLINK

/** @brief <b>plugin bulb-pwm ledOff [time:1] </b>
 *   - <i>Exercise the blink led off command.</i>
 *     - time - INT8U - time
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_BULB_PWM_CLI_PLUGIN_BULB_PWM_LED_OFF

/** @brief <b>plugin bulb-pwm ledOn [time:1] </b>
 *   - <i>Exercise the blink led on command.</i>
 *     - time - INT8U - time
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_BULB_PWM_CLI_PLUGIN_BULB_PWM_LED_ON

/** @brief <b>plugin bulb-pwm ledPattern [count:1] [pattern:-1] </b>
 *   - <i>Exercise the blink led pattern command.</i>
 *     - count - INT8U - count
 *     - pattern - OCTET_STRING - pattern
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_BULB_PWM_CLI_PLUGIN_BULB_PWM_LED_PATTERN

/** @brief <b>plugin bulb-pwm set [channel:1] [value:2] </b>
 *   - <i>Set the channel to the specific value.</i>
 *     - channel - INT8U - Channel
 *     - value - INT16U - Value
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_BULB_PWM_CLI_PLUGIN_BULB_PWM_SET

/** @brief <b>plugin bulb-pwm statusBlink [count:1] [time:2] </b>
 *   - <i>Exercise the blink status command.</i>
 *     - count - INT8U - count
 *     - time - INT16U - time
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_BULB_PWM_CLI_PLUGIN_BULB_PWM_STATUS_BLINK

/** @brief <b>plugin bulb-pwm statusOff [time:1] </b>
 *   - <i>Exercise the blink status off command.</i>
 *     - time - INT8U - time
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_BULB_PWM_CLI_PLUGIN_BULB_PWM_STATUS_OFF

/** @brief <b>plugin bulb-pwm statusOn [time:1] </b>
 *   - <i>Exercise the blink status on command.</i>
 *     - time - INT8U - time
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_BULB_PWM_CLI_PLUGIN_BULB_PWM_STATUS_ON

/** @brief <b>plugin bulb-pwm statusPattern [count:1] [pattern:-1] </b>
 *   - <i>Exercise teh blink status pattern command.</i>
 *     - count - INT8U - count
 *     - pattern - OCTET_STRING - pattern
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_PLUGIN_BULB_PWM_CLI_PLUGIN_BULB_PWM_STATUS_PATTERN

/** @} */ // end group plugin-bulb-pwm-cli
