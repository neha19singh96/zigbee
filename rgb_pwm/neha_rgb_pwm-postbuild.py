...
def S37():
    ...
    if ("gcc" == "iar" or "gcc" == ""):
        ...
        GCC_TOOLCHAIN_PATH = shortPath(r"file:/home/neha/SIMPLICITY_STUDIO/SimplicityStudio-v4/SimplicityStudio_v4/developer/toolchains/gnu_arm/7.2_2017q4/".replace(
            "file:", "").replace("%20", " "))
...
def EBL():
    ...
    print (" ")
    EBL_COMMAND = START_FLAGS + shortPath(r"/home/neha/SIMPLICITY_STUDIO/SimplicityStudio-v4/SimplicityStudio_v4/developer/adapter_packs/commander/commander").replace(
        " ", "\ ") + " ebl create " + EBL_FILE + " --app " + S37_BINARY + " --device EFR32MG12P432F1024GL125 " + CONVERT_FLAGS
...
def GBL():
    ...
    GBL_COMMAND = START_FLAGS + shortPath(r"/home/neha/SIMPLICITY_STUDIO/SimplicityStudio-v4/SimplicityStudio_v4/developer/adapter_packs/commander/commander").replace(
        " ", "\ ") + " gbl create " + GBL_FILE + " --app " + S37_BINARY + " --device EFR32MG12P432F1024GL125"
