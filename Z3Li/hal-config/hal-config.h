...
#define BSP_BULBPWM_TIMER                     (TIMER0)
#define HAL_BULBPWM_WHITE_ENABLE              (1)
#define HAL_BULBPWM_LOWTEMP_ENABLE            (0)
#define HAL_BULBPWM_STATUS_ENABLE             (0)
#define BSP_BULBPWM_CC0_PIN                   (9U)
#define BSP_BULBPWM_CC0_PORT                  (gpioPortC)
#define BSP_BULBPWM_CC0_LOC                   (14U)

// [BULBPWM]$

// $[BULBPWM_COLOR]
#define HAL_BULBPWM_COLOR_ENABLE              (1)

#define HAL_BULBPWM_COLOR_FREQUENCY           (1000U)
#define BSP_BULBPWM_COLOR_TIMER               (TIMER1)
#define HAL_BULBPWM_RED_ENABLE                (1)
#define HAL_BULBPWM_GREEN_ENABLE              (1)
#define HAL_BULBPWM_BLUE_ENABLE               (0)
#define HAL_BULBPWM_AMBER_ENABLE              (0)
#define BSP_BULBPWM_COLOR_CC0_PIN             (9U)
#define BSP_BULBPWM_COLOR_CC0_PORT            (gpioPortD)
#define BSP_BULBPWM_COLOR_CC0_LOC             (17U)

#define BSP_BULBPWM_COLOR_CC1_PIN             (10U)
#define BSP_BULBPWM_COLOR_CC1_PORT            (gpioPortD)
#define BSP_BULBPWM_COLOR_CC1_LOC             (17U)
...
// $[TIMER0]
#define PORTIO_TIMER0_CC0_PIN                 (9U)
#define PORTIO_TIMER0_CC0_PORT                (gpioPortC)
#define PORTIO_TIMER0_CC0_LOC                 (14U)

#define BSP_TIMER0_CC0_PIN                    (9U)
#define BSP_TIMER0_CC0_PORT                   (gpioPortC)
#define BSP_TIMER0_CC0_LOC                    (14U)

// [TIMER0]$

// $[TIMER1]
#define PORTIO_TIMER1_CC0_PIN                 (9U)
#define PORTIO_TIMER1_CC0_PORT                (gpioPortD)
#define PORTIO_TIMER1_CC0_LOC                 (17U)

#define PORTIO_TIMER1_CC1_PIN                 (10U)
#define PORTIO_TIMER1_CC1_PORT                (gpioPortD)
#define PORTIO_TIMER1_CC1_LOC                 (17U)

#define BSP_TIMER1_CC0_PIN                    (9U)
#define BSP_TIMER1_CC0_PORT                   (gpioPortD)
#define BSP_TIMER1_CC0_LOC                    (17U)

#define BSP_TIMER1_CC1_PIN                    (10U)
#define BSP_TIMER1_CC1_PORT                   (gpioPortD)
#define BSP_TIMER1_CC1_LOC                    (17U)
